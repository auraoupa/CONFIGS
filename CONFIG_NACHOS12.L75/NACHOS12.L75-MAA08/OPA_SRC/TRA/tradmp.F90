...
!{ DRAKKAR
      ELSE IF ( nn_hdmp == -2 ) THEN  !
       !--------------------------------------------------------------------------------------------------------------
       ! 3D restoring at the entrance of :
       ! Hudson Bay :
       ! Lonmin     ! Lonmax       ! Latmin        ! Latmax       ! Band      !
       ! min relax time   !
       !  deg E     ! deg E        !  deg N        ! Deg N        !  deg      !
       !  days           !
       zlon1 = -72 ; zlon2 = -74 ;  zlat1 = 61 ; zlat2 = 63 ; zbw = 0.  ;
       ztrelax = 30. 
       ...
       !  deg E     ! deg E        !  deg N        ! Deg N        !  deg      !
       !  days           !
       zlon1 = 9 ; zlon2 = 11 ;  zlat1 = 56.5 ; zlat2 = 60 ; zbw = 0.  ;
       ztrelax = 30.
